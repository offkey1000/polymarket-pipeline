...
import {
  M01, M02, M03, M04, M05, MPurpose, MGoal, M06, MStack,
  M07, M08, M09, MJobs, M10, M11, M12, MVision, M13,
} from "./scenes/film";

// KSIEP — "Returning with a Kerala Technology Thesis" (~5:40).
...
const SCENES: { c: React.FC; d: number }[] = [
  ...
  { c: M05, d: 500 },     // what KSIEP is (+ Technopark for Electronics)
  { c: MPurpose, d: 520 }, // purpose
  { c: MGoal, d: 620 },   // the goal — global benchmarks + AI layer
  ...
  { c: M12, d: 520 },     // the thesis — not capital mobilization
  { c: MVision, d: 560 }, // vision 2035
  { c: M13, d: 680 },     // finale — KPP-N 2.0
];
